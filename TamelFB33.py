...
if selected2=="Review Kinerja":
    ...
    kg_tujuan=datapage4.groupby(['bulan','asal_new'])['berat'].sum().reset_index().sort_values(['bulan'], ascending=False).reset_index(drop=True)

    st.table(kg_tujuan[(kg_tujuan.asal_new=='CBH')])
